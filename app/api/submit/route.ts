...
export async function POST(request: Request) {
  try {
    ...
    try {
      const GF_CREDENTIAL_ID = process.env.GOFUNNEL_WEBHOOK_CREDENTIAL_ID || "c0c22507-3da7-4f8e-91dd-fa8eab230cdc"
      const GF_BEARER = process.env.GOFUNNEL_WEBHOOK_SECRET || "39d989fe-fb93-46a7-b798-93883313555b"
      if (GF_CREDENTIAL_ID && GF_BEARER) {
        ...
        const gfPayload = {
          ...
          sid: gfSid || undefined,
          formId: "helpful-homebuyer-li-survey",
          formTitle: "Helpful Homebuyer LI Survey",
